...
public class ValidadorHorarioAntecedencia implements ValidadorCancelamentoConsulta {
    ...
    @Override
    public void validar(Long idConsulta, DadosCancelamentoConsulta dadosCancelamentoConsulta) {
        var consulta = this.consultaRepository.getReferenceById(idConsulta);
